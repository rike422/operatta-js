  ...
  Test.prototype = {
    ...
    run: function () {
      ...
      try {
        ...
        this.pushFailure("Died on test #" + ( this.assertions.length + 1 ) + " " + this.stack + ": " + ( e.message || e ),
    ...
    finish: function () {
      ...
      if (config.requireExpects && this.expected === null) {
        ...
        this.pushFailure("Expected at least one assertion, but none were run - call expect(0) to accept zero assertions.",
          this.stack);
      }
